...
export async function addMessage(conversationId: number, role: string, content: string, isAutogenerated: boolean = false) {
    ...
    message.isAutogenerated = isAutogenerated
